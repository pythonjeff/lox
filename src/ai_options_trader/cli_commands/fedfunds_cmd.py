...
from ai_options_trader.cli_commands.fedfunds_display import (
    build_regime_table,
...
from ai_options_trader.cli_commands.fedfunds_display_extended import (
...
def register(monetary_app: typer.Typer) -> None:
    ...
    def fedfunds_outlook(
        ...
        if llm:
            try:
                from ai_options_trader.llm.monetary_outlook import llm_fedfunds_outlook
