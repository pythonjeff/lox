...
from lox.nav.store import _parse_ts, get_data_dir, read_nav_sheet
...
def default_investor_flows_path() -> str:
    ...
    return os.environ.get("AOT_NAV_INVESTOR_FLOWS", "") or os.path.join(
        get_data_dir(), "nav_investor_flows.csv"
    )
