...
def register(app: typer.Typer) -> None:
    ...
    def dashboard(
        ...
        from lox.regimes.dashboard import create_default_dashboard
...
def register_pillar_commands(app: typer.Typer) -> None:
    ...
    def inflation_cmd(
        ...
        from lox.regimes.pillars import InflationPillar
    ...
    def growth_cmd(
        ...
        from lox.regimes.pillars import GrowthPillar
    ...
    def liquidity_cmd(
        ...
        from lox.regimes.pillars import LiquidityPillar
