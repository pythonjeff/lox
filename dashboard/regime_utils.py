...
_REGIME_METRICS_SPEC = {
    ...
    "growth": [
        ...
        {"key": "ism_new_orders", "name": "Factory New Orders (ISM)", "weight": 0.10, "fmt": _dec1,
         "desc": "Forward-looking demand for goods",
         "healthy": 55, "stressed": 42, "healthy_label": "55", "stressed_label": "42",
         "inverted": True},
        {"key": "curve_2s10s", "name": "Yield Curve (2s/10s)", "weight": 0.10, "fmt": lambda v: f"{v:+.2f}%",
         "desc": "Negative = classic recession signal",
         "healthy": 1.0, "stressed": -0.5, "healthy_label": "+1.0%", "stressed_label": "-0.5%",
         "inverted": True},
        {"key": "consumer_expectations", "name": "Consumer Expectations", "weight": 0.08, "fmt": _dec1,
    ...
    # ── Credit (9 metrics) ──────────────────────────────────────────────────
    "credit": [
        {"key": "hy_oas", "name": "Junk Bond Spread (HY)", "weight": 0.18, "fmt": _bp,
        ...
        {"key": "bbb_oas", "name": "Investment Grade Spread (BBB)", "weight": 0.12, "fmt": _bp,
        ...
        {"key": "hy_ig_spread", "name": "Junk vs IG Gap", "weight": 0.11, "fmt": _bp,
        ...
        {"key": "ccc_oas", "name": "Distressed Debt Spread (CCC)", "weight": 0.10, "fmt": _bp,
        ...
        {"key": "bb_oas", "name": "Mid-Grade Junk Spread (BB)", "weight": 0.09, "fmt": _bp,
         "desc": "Largest junk bond segment by volume",
         "healthy": 200, "healthy_label": "Tight", "stressed": 400, "stressed_label": "Widening",
         "extreme": 700, "extreme_date": "Mar 2020", "extreme_event": "COVID", "inverted": False},
        {"key": "aaa_oas", "name": "Safest Corporate Spread (AAA)", "weight": 0.08, "fmt": _bp,
        ...
        {"key": "hy_oas_30d_chg", "name": "Junk Spread Momentum (30d)", "weight": 0.10, "fmt": _bpS,
        ...
        {"key": "sloos_tightening", "name": "Bank Lending Standards", "weight": 0.12, "fmt": lambda v: f"{v:+.0f}%",
        ...
        {"key": "cc_delinquency_rate", "name": "Credit Card Delinquency", "weight": 0.10, "fmt": _pct,
    ...
    # ── Consumer (9 metrics) ────────────────────────────────────────────────
    "consumer": [
        {"key": "michigan_sentiment", "name": "Consumer Confidence", "weight": 0.15, "fmt": _idx,
        ...
        {"key": "mortgage_30y", "name": "Mortgage Rate (30Y)", "weight": 0.13, "fmt": _pct2,
        ...
        {"key": "retail_sales_control_mom", "name": "Retail Spending MoM", "weight": 0.12, "fmt": _pctS,
        ...
        {"key": "michigan_expectations", "name": "Consumer Outlook", "weight": 0.11, "fmt": _idx,
        ...
        {"key": "credit_yoy", "name": "Consumer Borrowing YoY", "weight": 0.11, "fmt": _pctS,
        ...
        {"key": "savings_rate", "name": "Personal Savings Rate", "weight": 0.10, "fmt": _pct,
        ...
        {"key": "home_prices_yoy", "name": "Home Prices YoY", "weight": 0.10, "fmt": _pctS,
        ...
        {"key": "delinquency", "name": "Loan Delinquency Rate", "weight": 0.09, "fmt": _pct,
        ...
        {"key": "auto_tightening", "name": "Auto Loan Standards", "weight": 0.09, "fmt": lambda v: f"{v:+.0f}%",
